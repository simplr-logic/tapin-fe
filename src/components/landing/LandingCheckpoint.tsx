      ...
      <div className={landingContainerClass}>
        <div className="max-w-3xl mx-auto text-center md:text-left">
          ...
          <p className="mt-4 text-sm md:text-base text-ink-muted leading-relaxed text-balance">
            No stopwatch to start. No form to fill. Tap a project, and it&apos;s logged — instantly,
            satisfyingly, done. Your brain doesn&apos;t file it as admin work. It files it as
            progress.
          </p>
        </div>
      </div>
